...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    // Actualizar la decisión en la tabla `auditoriainterna`
    $actualizar_objetivo = "UPDATE datosauditoria.auditoriainterna SET SeAceptanRecomendaciones = :descripcion_objetivo WHERE nrotramite = :nrotramite";
    ...
    SELECT (flujo + 1), '¿Se Aceptan las Recomendaciones?', :usuario, :fecha_inicio, null
    FROM `seguimiento` 
...
<head>
    ...
    <title>¿Se Aceptan las Recomendaciones?</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-9 offset-md-3">
                <h2>¿Se Aceptan las Recomendaciones?</h2>
                <hr>

                <h4 class="mt-4">Evaluacion-Informe</h4>
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col">Nro. Trámite</th>
                            <th scope="col">¿Se Aceptan las Recomendaciones Del Informe?</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <?php
                                        $descripcion = ($registro['SeAceptanRecomendaciones'] === null) ? 'No se evalúo' : (($registro['SeAceptanRecomendaciones'] === 0) ? 'NO' : 'SI');
                                        ?>
