...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    $actualizar_objetivo = "UPDATE datosauditoria.auditoriainterna SET SeguimientoRecomendaciones = :descripcion_objetivo WHERE nrotramite = :nrotramite";
...
$query = "SELECT * FROM datosauditoria.auditoriainterna where SeguimientoRecomendaciones is not null";
...
<head>
    ...
    <title>Seguimiento de Recomendaciones - Auditoria Interna</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-9 offset-md-3">
                <h2>Seguimiento de Recomendaciones - Auditoria Interna</h2>
                <hr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <textarea class="form-control" name="descripcion_objetivo" rows="2"><?php echo $registro['SeguimientoRecomendaciones']; ?></textarea>
