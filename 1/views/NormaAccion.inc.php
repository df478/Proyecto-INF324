...
$verificar_debilidad = "SELECT CumpleConNormasYRegulaciones FROM datosauditoria.cumplimiento 
                        ORDER BY nrotramite DESC LIMIT 1;";
$stmt_verificar = $pdo->prepare($verificar_debilidad);
$stmt_verificar->execute();
$resultado = $stmt_verificar->fetch(PDO::FETCH_ASSOC);

if ($resultado && $resultado['CumpleConNormasYRegulaciones'] !== 1) {
    ...
    if (isset($_POST['accion']) && $_POST['accion'] === 'anadir' && isset($_POST['descripcion_objetivo'])) {
        ...
        SELECT (flujo + 1), 'Acciones Correctivas', :usuario, :fecha_inicio, NULL
        FROM `seguimiento` 
        ...
        if ($stmt_insertar->execute()) {
            $sql = "SELECT * FROM datosauditoria.cumplimiento order by nrotramite desc limit 1";
            $stmt_valores = $pdo->prepare($sql);
            $stmt_valores->execute();
            $valores = $stmt_valores->fetch(PDO::FETCH_ASSOC);
            $establecer_objetivos_desenpeno = $valores['CumplimientoDeNormas'];
...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    $actualizar_objetivo = "UPDATE datosauditoria.cumplimiento SET AccionesCorrectivas = :descripcion_objetivo WHERE nrotramite = :nrotramite";
...
$query = "SELECT * FROM datosauditoria.cumplimiento where AccionesCorrectivas is not null";
...
<head>
    ...
    <title>Acciones Correctivas - Cumplimiento</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-9 offset-md-3">
                <h2>Acciones Correctivas - Cumplimiento</h2>
                <hr>
                ...
                <h4 class="mt-4">Evaluacion-Cumplimiento</h4>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <textarea class="form-control" name="descripcion_objetivo" rows="2"><?php echo $registro['AccionesCorrectivas']; ?></textarea>
