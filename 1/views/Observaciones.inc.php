...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    WHERE proceso LIKE 'Seguimiento de Recomendaciones' AND nrotramite = :nrotramite_a_actualizar
    ...
    VALUES (:nrotramite_a_actualizar, 2, 'Resolución de observaciones y recomendaciones', :usuario, :fecha_inicio, NULL);";
