...
<head>
    ...
    <title>Elaboración de Informes - PlaneacionEstrategica</title>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <textarea class="form-control" name="descripcion_objetivo" rows="2"><?php echo $registro['ElaboracionDeInformes']; ?></textarea>
