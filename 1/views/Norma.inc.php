...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    WHERE proceso LIKE '¿Existen Riesgos Significativos?' AND nrotramite = :nrotramite_a_actualizar
    ...
    VALUES (:nrotramite_a_actualizar, 1, 'Cumplimiento de Normas', :usuario, :fecha_inicio, NULL);";
