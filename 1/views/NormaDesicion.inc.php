...
$verificar_fecha_fin = "SELECT fecha_fin FROM `seguimiento` 
                        WHERE proceso LIKE 'Cumplimiento de Normas' 
...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    // Actualizar la decisión en la tabla `cumplimiento`
    $actualizar_objetivo = "UPDATE datosauditoria.cumplimiento SET CumpleConNormasYRegulaciones = :descripcion_objetivo WHERE nrotramite = :nrotramite";
...
<head>
    ...
    <title>¿Cumple con Normas y Regulaciones?</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-9 offset-md-3">
                <h2>¿Cumple con Normas y Regulaciones?</h2>
                <hr>

                <h4 class="mt-4">Evaluacion-Normas</h4>
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col">Nro. Trámite</th>
                            <th scope="col">¿Cumple con Normas y Regulaciones?</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <?php
                                        $descripcion = ($registro['CumpleConNormasYRegulaciones'] === null) ? 'No se evalúo' : (($registro['CumpleConNormasYRegulaciones'] === 0) ? 'NO' : 'SI');
                                        ?>
