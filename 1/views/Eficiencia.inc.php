...
if ($resultado && $resultado['fecha_fin'] !== null) {
    ...
    if (isset($_POST['accion']) && $_POST['accion'] === 'anadir' && isset($_POST['descripcion_objetivo'])) {
        ...
        SELECT (flujo + 1), 'Eficiencia Operativa', :usuario, :fecha_inicio, NULL
        FROM `seguimiento` 
...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    $actualizar_objetivo = "UPDATE datosauditoria.operaciones SET EficienciaOperativa = :descripcion_objetivo WHERE nrotramite = :nrotramite";
...
$query = "SELECT * FROM datosauditoria.operaciones where EficienciaOperativa is not null";
...
<head>
    ...
    <title>Eficiencia Operativa - Operaciones</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-9 offset-md-3">
                <h2>Eficiencia Operativa - Operaciones</h2>
                <hr>
                ...
                <h4 class="mt-4">Evaluacion-Eficiencia Operativa</h4>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <textarea class="form-control" name="descripcion_objetivo" rows="2"><?php echo $registro['EficienciaOperativa']; ?></textarea>
