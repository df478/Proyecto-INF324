...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    WHERE proceso LIKE '¿Cumple con Normas y Regulaciones?' AND nrotramite = :nrotramite_a_actualizar
    ...
    VALUES (:nrotramite_a_actualizar, 1, 'Eficiencia Operativa', :usuario, :fecha_inicio, NULL);";
