...
$verificar_debilidad = "SELECT SeCumplenLosObjetivosDelDesempeno FROM datosauditoria.planeacionestrategica 
...
if ($resultado && $resultado['SeCumplenLosObjetivosDelDesempeno'] !== 1) {
    ...
    if (isset($_POST['accion']) && $_POST['accion'] === 'anadir' && isset($_POST['descripcion_objetivo'])) {
        ...
        SELECT (flujo + 1), 'Recomendaciones para Mejorar Desempeño', :usuario, :fecha_inicio, NULL
        FROM `seguimiento` 
        ...
        if ($stmt_insertar->execute()) {
            ...
            VALUES (LAST_INSERT_ID(), :establecer_objetivos_desenpeno, null, :descripcion_objetivo,null)";
...
if (isset($_POST['eliminar_objetivo'])) {
    ...
    // Eliminar registro de la tabla `planeacionestrategica`
    $eliminar_objetivo = "DELETE FROM datosauditoria.planeacionestrategica WHERE nrotramite = :nrotramite";
...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    $actualizar_objetivo = "UPDATE datosauditoria.planeacionestrategica SET RecomendacionesParaMejorarDesempeno = :descripcion_objetivo WHERE nrotramite = :nrotramite";
...
$query = "SELECT * FROM datosauditoria.planeacionestrategica where RecomendacionesParaMejorarDesempeno is not null";
...
<head>
    ...
    <title>Recomendaciones para Mejorar Desempeño - Planeacion Estrategica</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-9 offset-md-3">
                <h2>Recomendaciones para Mejorar Desempeño - Planeacion Estrategica</h2>
                <hr>
                ...
                <h4 class="mt-4">Evaluacion-Planeacion Estrategica</h4>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <textarea class="form-control" name="descripcion_objetivo" rows="2"><?php echo $registro['RecomendacionesParaMejorarDesempeno']; ?></textarea>
