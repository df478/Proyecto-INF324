...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    WHERE proceso LIKE '¿Es Eficiente la Operación?' AND nrotramite = :nrotramite_a_actualizar
    ...
    VALUES (:nrotramite_a_actualizar, 1, 'Medición del Desempeño', :usuario, :fecha_inicio, NULL);";
