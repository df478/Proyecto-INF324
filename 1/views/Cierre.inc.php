...
$verificar_fecha_fin = "SELECT fecha_fin FROM `seguimiento` 
                        WHERE proceso LIKE 'Resolución de observaciones y recomendaciones' 
...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    $actualizar_objetivo = "UPDATE datosauditoria.auditoriainterna SET CierreAuditoria = :descripcion_objetivo WHERE nrotramite = :nrotramite";
    ...
    VALUES (:nrotramite_a_actualizar, 2, 'Cierre de Auditoría', :usuario, :fecha_inicio, NULL);";
...
<head>
    ...
    <title>Cierre de Auditoría</title>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">¿Se concluye la auditoría?</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <?php
                                        $descripcion = ($registro['CierreAuditoria'] === null) ? 'No se evalúo' : (($registro['CierreAuditoria'] === 0) ? 'NO' : 'SI');
                                        ?>
