...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    // Actualizar la decisión en la tabla `planeacionestrategica`
    $actualizar_objetivo = "UPDATE datosauditoria.planeacionestrategica SET SeCumplenLosObjetivosDelDesempeno = :descripcion_objetivo WHERE nrotramite = :nrotramite";
...
<head>
    ...
    <title>¿Se Cumplen los Objetivos del Desempeño?</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-9 offset-md-3">
                <h2>¿Se Cumplen los Objetivos del Desempeño?</h2>
                <hr>

                <h4 class="mt-4">Evaluacion-Desempeño</h4>
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col">Nro. Trámite</th>
                            <th scope="col">¿Se Cumplen los Objetivos del Desempeño?</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <?php
                                        $descripcion = ($registro['SeCumplenLosObjetivosDelDesempeno'] === null) ? 'No se evalúo' : (($registro['SeCumplenLosObjetivosDelDesempeno'] === 0) ? 'NO' : 'SI');
                                        ?>
