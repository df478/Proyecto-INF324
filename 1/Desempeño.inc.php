...
if ($resultado && $resultado['fecha_fin'] !== null) {
    ...
    if (isset($_POST['accion']) && $_POST['accion'] === 'anadir' && isset($_POST['descripcion_objetivo'])) {
        ...
        SELECT (flujo + 1), 'Medición del Desempeño', :usuario, :fecha_inicio, NULL
        FROM `seguimiento` 
        ...
        if ($stmt_insertar->execute()) {
            // Segunda consulta: Insertar un registro en la tabla `planeacionestrategica`
            ...
            VALUES (LAST_INSERT_ID(), :descripcion_objetivo, null, null,null)";
...
if (isset($_POST['accion']) && $_POST['accion'] === 'editar' && isset($_POST['descripcion_objetivo'])) {
    ...
    $actualizar_objetivo = "UPDATE datosauditoria.planeacionestrategica SET MedicionDelDesempeno = :descripcion_objetivo WHERE nrotramite = :nrotramite";
...
$query = "SELECT * FROM datosauditoria.planeacionestrategica where MedicionDelDesempeno is not null";
...
<head>
    ...
    <title>Medición del Desempeño - PlaneacionEstrategica</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-9 offset-md-3">
                <h2>Medición del Desempeño - Planeacion Estrategica</h2>
                <hr>
                ...
                <h4 class="mt-4">Evaluacion-Medición del Desempeño</h4>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <textarea class="form-control" name="descripcion_objetivo" rows="2"><?php echo $registro['MedicionDelDesempeno']; ?></textarea>
